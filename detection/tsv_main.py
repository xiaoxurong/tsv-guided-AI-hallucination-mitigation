...
def train_model(model, optimizer, device, prompts, labels, args):
    ...
    layer_number = -1
    dir_name = f"TSV_{args.model_name}_{args.dataset_name}/{args.loss_type}/exemplar_num_{args.num_exemplars}_num_selected_data_{args.num_selected_data}/{args.component}/{args.str_layer}/{args.lam}"
    log_dir = f"{dir_name}/"
    ...
    centroids = torch.randn((2, model.config.hidden_size), 
